    ...
    public boolean[][] possibleMoves() {
        ...
        if (getMoveCount() == 0 && !chessMatch.isCheck()) {
            ...
            if (testRookCastling(positionT1)) {
                Position p1 = new Position((positionT1.getRow()), position.getColumn() + 1);
                Position p2 = new Position((positionT1.getRow()), position.getColumn() + 2);
            ...
            if (testRookCastling(positionT2)) {
                Position p1 = new Position((positionT1.getRow()), position.getColumn() - 1);
                Position p2 = new Position((positionT1.getRow()), position.getColumn() - 2);
                Position p3 = new Position((positionT1.getRow()), position.getColumn() - 2);
